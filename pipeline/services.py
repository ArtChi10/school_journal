...
_CRITERION_EVALUATION_PROMPT = (
    ...
    "Критерий может быть на русском, английском или другом языке таблицы. "
    "Английский язык сам по себе не является ошибкой.\n"
    "Если критерий на английском, оценивай его на английском: не требуй русскую форму глагола 3-го лица "
